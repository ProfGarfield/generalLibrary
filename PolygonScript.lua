...
work again.]]
pSIT2=[[^]]
pSIT3=[[You can store up to 10 polygons at a time.  You can change the polygon you are working on by pressing 'Tab'.]]
pSIT4=[[^]]
pSIT5=[[The 'K' key adds a vertex (corner) to the polygon and places a barbarian to mark the corner.  The unitType placed for each polygon can be changed in the file PolygonScript.lua.]]
pSIT6=[[^]]
